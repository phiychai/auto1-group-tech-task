...
import CarsCollection from '@/components/CarsCollection'; // Add this import
...
it('should display loading skeletons when isLoading is true', () => {
  ...
  const skeletons = getAllByRole('img', { hidden: true });
  expect(skeletons).toHaveLength(mockCarsCollectionPaginated.cars.length * 3);
});